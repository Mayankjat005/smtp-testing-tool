...
<body class="bg-gray-50 min-h-screen p-4">
  <nav class="bg-white shadow-md rounded-lg max-w-5xl mx-auto mb-6 p-4 flex justify-between items-center">
    <div class="flex items-center space-x-4">
      ...
      <a href="../index.php" class="text-blue-600 hover:underline" target="_blank">View Site</a>
    </div>
  ...
  <main class="max-w-5xl mx-auto bg-white rounded-lg shadow-lg p-8 space-y-8">
    ...
    <section id="menu-footer-section">
      ...
      <form id="menuFooterForm" class="space-y-4 max-w-3xl">
        <div>
          ...
          <textarea id="primaryMenu" name="primaryMenu" rows="4" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 font-mono text-sm" placeholder='[{"name":"Home","url":"index.php"}]'></textarea>
          <p class="text-sm text-gray-500 mt-1">Example: [{"name":"Home","url":"index.php"},{"name":"About","url":"about.php"}]</p>
        </div>
        <div>
    ...
    <section id="blog-posts-section">
      ...
      <div id="blogPostsList" class="mb-4 space-y-4">
